...
public class DashboardAuthenticateUtils {
	...
	public static String getThemeColor(int type) {
		String color = DashboardAuthenticateConstants.DANGER;
		if(type%5 == 0) {
			color = DashboardAuthenticateConstants.PRIMARY;
		}else if(type%5 == 1) {
			color = DashboardAuthenticateConstants.INFO;
		}else if(type%5 == 2) {
			color = DashboardAuthenticateConstants.WARNING;
		}else if(type%5 == 3) {
			color = DashboardAuthenticateConstants.SUCCESS;
		}else if(type%5 == 4) {
			color = DashboardAuthenticateConstants.DANGER;
		}
		return color;
	}
...
//		}
	...
	public static String getPortfolioName(String id) {
		String name = "";
		switch(id) {
			case DashboardAuthenticateConstants.PORTFOLIO_PCMS :
				name = "PCMS";
				break;
			case DashboardAuthenticateConstants.PORTFOLIO_CS :
				name = "CS";
				break;
			case DashboardAuthenticateConstants.PORTFOLIO_CMS :
				name = "CMS";
				break;
			case DashboardAuthenticateConstants.PORTFOLIO_RHEMS :
				name = "RHEMS";
				break;
		}
		return name;
	...
	public static Boolean isNull(String string) {
		Boolean result = (string.isEmpty() || string == null) ? true : false;
		return result;
	}
